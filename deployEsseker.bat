...
RD /s /q "%ClientDirectory%\Missions\DayZCommunityOfflineMode.Esseker" > NUL
xcopy /s/e /y /i "%cd%\Missions\DayZCommunityOfflineMode.Esseker" "%ClientDirectory%\Missions\DayZCommunityOfflineMode.Esseker" > NUL

chdir /d "%ClientDirectory%\Missions\DayZCommunityOfflineMode.Esseker"
