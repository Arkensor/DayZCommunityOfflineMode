...
// COM_GetSpawnPoints() now utilizes worldMap to select positions.
// - Brandon10x15

string worldMap = GetGame().GetWorldName();
string gameVersion;
string objectsFilename = "COMObjects";
...
{
	if(worldMap == "Enoch") {
        return { "1501.06 0 7454.06" };
	}
	else if(worldMap == "Namalsk")
	{
		return { "7000.50 0 11024.70" };
	}
	else
	{
