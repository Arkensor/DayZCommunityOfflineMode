...
#include "$CurrentDir:missions\\CommunityOfflineModeCore\\core\\modules\\DebugMonitor\\CustomDebugMonitor.c"
#include "$CurrentDir:missions\\CommunityOfflineModeCore\\core\\modules\\DebugMonitor\\gui\\DebugMonitor.c"
#endif
