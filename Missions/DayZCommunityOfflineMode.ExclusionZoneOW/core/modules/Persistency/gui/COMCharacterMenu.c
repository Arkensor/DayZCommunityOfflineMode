class COMCharacterMenu extends UIScriptedMenu
{
	...
	override Widget Init()
	{
		...
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\Persistency\\gui\\layouts\\COMCharacterMenu.layout" );
