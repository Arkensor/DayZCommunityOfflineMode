...
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\Module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\KeyMouseBinding.c"

#ifdef COM_MODULES_OLDLOADING
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\Admintool\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\CameraTool\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\ComEditor\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\ComKeyBinds\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\ComMenu\\module.c"
//#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\Persistency\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\DebugMonitor\\module.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZoneOW\\core\\modules\\BarrelCrosshair\\module.c"
#endif
