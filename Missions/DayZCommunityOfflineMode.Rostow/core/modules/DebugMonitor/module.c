...
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.Rostow\\core\\modules\\DebugMonitor\\CustomDebugMonitor.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.Rostow\\core\\modules\\DebugMonitor\\gui\\DebugMonitor.c"
#endif
