class COMCharacterMenu extends UIScriptedMenu
{
	...
	override Widget Init()
	{
		...
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\DayZCommunityOfflineMode.ExclusionZone\\core\\modules\\Persistency\\gui\\layouts\\COMCharacterMenu.layout" );
