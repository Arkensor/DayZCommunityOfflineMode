...
static Weapon_Base COM_CreateWeapon( PlayerBase oPlayer )
{
    ...
    oWpn.GetInventory().CreateAttachment( "GhillieAtt_Mossy" );
...
static PlayerBase COM_CreateCustomDefaultCharacter()
{
    ...
    */
    ...
    PlayerBase oVest = oPlayer.GetInventory().CreateInInventory( "PlateCarrierVest_Camo" );
    oVest.GetInventory().CreateAttachment( "PlateCarrierHolster_Camo" );
    oVest.GetInventory().CreateAttachment( "PlateCarrierPouches_Camo" );
    ...
    // oBelt.GetInventory().CreateAttachment( "PlateCarrierHolster_Camo" );
    ...
    oPlayer.GetInventory().CreateInInventory( "BalaclavaMask_Beige" ); // BalaclavaMask_BDU | BalaclavaMask_Green | BalaclavaMask_Beige
    oPlayer.GetInventory().CreateInInventory( "TacticalGloves_Beige" ); // TacticalGloves_Black | TacticalGloves_Green | TacticalGloves_Beige
    oPlayer.GetInventory().CreateInInventory( "Armband_Yellow" ); // Armband_Yellow | Armband_Green | Armband_Black
    oPlayer.GetInventory().CreateInInventory( "TTSKOBoots" );
    oPlayer.GetInventory().CreateInInventory( "Rangefinder" ).GetInventory().CreateAttachment( "Battery9V" );

    /* Camo set */
    PlayerBase oBag = oPlayer.GetInventory().CreateInInventory( "TortillaBag" ); // AliceBag_Camo | CoyoteBag_Green | TortillaBag
    oBag.GetInventory().CreateAttachment( "GPSReceiver" ).GetInventory().CreateAttachment( "Battery9V" ); // PersonalRadio | GPSReceiver

    oPlayer.GetInventory().CreateInInventory( "BallisticHelmet_Woodland" ); // BallisticHelmet_Green | BallisticHelmet_Woodland
    oPlayer.GetInventory().CreateInInventory( "USMCJacket_Woodland" ); // USMCJacket_Woodland | TTsKOJacket_Camo
    oPlayer.GetInventory().CreateInInventory( "USMCPants_Woodland" ); // USMCPants_Woodland | TTSKOPants

    /* Ghillie set */
    // oBag.GetInventory().CreateInInventory( "GhillieHood_Mossy" );
    // oBag.GetInventory().CreateInInventory( "GhillieSuit_Mossy" );
    // oBag.GetInventory().CreateInInventory( "SmershVest" ).GetInventory().CreateAttachment( "SmershBag" );
