class WelcomeMenu extends UIScriptedMenu
{
    ...
    {
        layoutRoot = GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\DayZCommunityOfflineMode.Esseker\\core\\modules\\ComMenu\\gui\\layouts\\WelcomeMenu.layout" );
