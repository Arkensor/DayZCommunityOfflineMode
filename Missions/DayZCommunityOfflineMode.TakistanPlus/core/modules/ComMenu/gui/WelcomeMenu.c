class WelcomeMenu extends UIScriptedMenu
{
    ...
    {
        layoutRoot = GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\DayZCommunityOfflineMode.TakistanPlus\\core\\modules\\ComMenu\\gui\\layouts\\WelcomeMenu.layout" );
