...
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.Namalsk\\core\\modules\\Settings\\SettingsData.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.Namalsk\\core\\modules\\Settings\\SettingsSave.c"
#endif
