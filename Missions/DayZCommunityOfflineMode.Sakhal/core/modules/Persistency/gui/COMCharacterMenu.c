class COMCharacterMenu extends UIScriptedMenu
{
	...
	override Widget Init()
	{
		...
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "$CurrentDir:missions\\DayZCommunityOfflineMode.Sakhal\\core\\modules\\Persistency\\gui\\layouts\\COMCharacterMenu.layout" );
