...
RD /s /q "%ClientDirectory%\Missions\CommunityOfflineModeCore" > NUL
xcopy /s/e /y /i "%cd%\Missions\CommunityOfflineModeCore" "%ClientDirectory%\Missions\CommunityOfflineModeCore" > NUL
chdir /d "%ClientDirectory%\Missions\CommunityOfflineModeCore"
